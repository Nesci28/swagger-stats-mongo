...
module.exports.getStatusCodeClass = (code) => {
...
module.exports.swsStringValue = (val) => {
  switch (typeof val) {
    case "string":
      return val;
    case "boolean":
...
module.exports.swsStringRecursive = (output, val) => {
...
module.exports.swsCastStringR = (val) => {
  switch (typeof val) {
    case "string":
      return val;
    case "boolean":
...
// returns string value of argument, depending on typeof
module.exports.swsNumValue = (val) => {
  const res = Number(val);
  return Number.isNaN(res) ? 0 : res;
};

// Calculate CPU Usage Percentage
module.exports.swsCPUUsagePct = (starthrtime, startusage) => {
  // On CPU - see
