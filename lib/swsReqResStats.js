...
class SwsReqResStats {
  constructor(apdexThreshold) {
    ...
    this.apdex_threshold =
      typeof apdexThreshold !== "undefined" ? apdexThreshold : 50; // Apdex threshold
  ...
  countResponse(code, codeclass, duration, clength) {
    this.responses += 1;
    this[codeclass] += 1;
    if (swsUtil.isError(code)) this.errors += 1;
