...
const swsHapi = require("./swsHapi.js");
...
async function handleRequest(req, res) {
  try {
    await swsProcessor.processRequest(req, res);
  } catch (e) {
...
async function handleResponseFinished(res) {
  try {
    await swsProcessor.processResponse(res);
  } catch (e) {
...
function fastifyPlugin(fastify, opts, done) {
  ...
  /*
     ...
     */
  fastify.addHook("onResponse", (request, reply, d) => {
